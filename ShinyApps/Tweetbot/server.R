...
file1 <- readLines("calafair_christianforum.txt", encoding = "ASCII", skipNul = TRUE)
file2 <- readLines("calafair_reddit.txt", encoding = "ASCII", skipNul = TRUE)
file3 <- readLines("miscellaneous_post_under_strawbelries.txt", encoding = "ASCII", skipNul = TRUE)
file4 <- readLines("strawbelrieswebsite.txt", encoding = "ASCII", skipNul = TRUE)
